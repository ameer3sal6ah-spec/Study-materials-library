  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full bg-white rounded-lg shadow-xl p-8">
        <h1 className="text-3xl font-bold text-red-600 mb-4">خطأ في الإعداد: Supabase غير مُهيأ</h1>
        <p className="text-gray-600 mb-6">
          يبدو أنك لم تقم بإعداد بيانات الاتصال بقاعدة بيانات Supabase. لمنع تعطل التطبيق، تم عرض هذه الصفحة الإرشادية.
        </p>
        
        <h2 className="text-2xl font-semibold text-gray-800 mb-3 border-b pb-2">الخطوات المطلوبة</h2>
        <ol className="list-decimal list-inside space-y-4 text-gray-700">
          <li>
            اذهب إلى لوحة تحكم مشروعك في <a href="https://supabase.com/" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline font-semibold">Supabase</a>.
          </li>
          <li>
          ...
          <li>
            ...
            <pre className="bg-gray-100 p-4 rounded-md mt-2 text-sm text-left dir-ltr overflow-x-auto">
              <code>
                ...
                <br />
                <br />
                <span className="text-gray-500">// After (Example)</span>
                <br />
